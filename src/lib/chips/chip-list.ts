...
import { BACKSPACE, LEFT_ARROW, RIGHT_ARROW } from '@metaclinic/cdk/keycodes';
...
import { MatFormFieldControl } from '@metaclinic/material/form-field';
...
export class MatChipList implements MatFormFieldControl<any>, ControlValueAccessor,
  ...
  get color() {
    return this._chipInput ? this._chipInput.color : this._color;
  }
  ...
  get label() {
    return this._chipInput ? this._chipInput.label : this._label;
  }
