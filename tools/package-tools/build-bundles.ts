...
/** Builds bundles for the primary entry-point w/ given entry file, e.g. @metaclinic/cdk */
...
/** Builds bundles for a single secondary entry-point w/ given entry file, e.g. @metaclinic/cdk/a11y */
